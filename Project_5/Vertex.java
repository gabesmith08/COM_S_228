...
public interface Vertex extends Visitable {
	...
	/**
	 * Returns the collection of the outgoing edges of this vertex. (The
	 * collection is the one used internally by the vertex.)
	 *
	 ...
	 *
	 * If the vertex is already visited, a cycle has been detected. Otherwise,
	 * marks the vertex as visited, then checks its neighbors (except for
	 * {@code from}) by calling {@code hasCycle(this)} on them.
	 *
	 * @param from
