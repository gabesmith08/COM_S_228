...
public class PolarAngleComparator implements Comparator<Point>
{
	...
	{
		Point temp1 = new Point((p1.getX() - referencePoint.getX()), (p1.getY() - referencePoint.getY())); // variables to hold temp points
		Point temp2 = new Point((p2.getX() - referencePoint.getX()), (p2.getY() - referencePoint.getY())); // to use cross product on
		
		if(p1.equals(p2) == true)
		{
			return 0;
		}
		else if(crossProduct(temp1, temp2) > 0) // all pretty clear in javadoc so no need to comment
		{
			return -1;
		}
		else if(crossProduct(temp1, temp2) == 0 && flag == true && dotProduct(temp1, temp1) < dotProduct(temp2, temp2))
		{
			return -1;
		}
		else if(crossProduct(temp1, temp2) == 0 && flag == false && dotProduct(temp1, temp1) > dotProduct(temp2, temp2))
		{
			return -1;
		}
		else
