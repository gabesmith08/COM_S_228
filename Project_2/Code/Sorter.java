...
public abstract class Sorter {
	 ...
	 * given {@code WordList} using the given {@code Comparator}, until the
	 * total number of words sorted <i>by this method call</i> reaches or
	 * exceeds the indicated amount. The contents of the given list <b>are
	 * not</b> modified. Exactly once per each call to
	 * {@code sortWithStatistics()}, write the sorted list to disk in a file
	 * named according to the class name (use
	...
	public void sortWithStatistics(WordList toSort, Comparator<String> comp, int totalToSort)
		...
		while(totalWordsSorted < totalToSort)
		{
			...
			try 
			{
				p = new PrintWriter(new File("Desktop/State/coms228/project2"));
			}
	 ...
	 *
	 * @return the total amount of time, in milliseconds, that this sorter has
	 *         used sorting within {@code sorterWithStatistics()}
	 */
	 ...
	 * while sorting within
	 * {@link #sortWithStatistics(WordList, Comparator, int)
	 * sorterWithStatistics()}.
	 *
	 * @return the total number of comparisons that this sorter has performed
	 *         while sorting within {@code sorterWithStatistics()}
	 */
